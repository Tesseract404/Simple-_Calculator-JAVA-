...
public class Calculator extends JFrame {
	...
	public Calculator() {
		...
		JLabel lblSimpleCalculator = new JLabel("Calculator");
		...
		panel_3.setBounds(35, 75, 209, 240);
		panel_2.add(panel_3);
		...
		JButton btnPercent = new JButton("Percent");
		btnPercent.setBackground(new Color(255, 182, 193));
		...
		btnPercent.setForeground(new Color(153, 12, 41));
		btnPercent.setFont(new Font("Tahoma", Font.BOLD, 16));
		btnPercent.setBounds(37, 196, 138, 27);
